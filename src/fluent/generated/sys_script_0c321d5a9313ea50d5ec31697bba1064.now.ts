...
export default BusinessRule({
    $id: '0c321d5a9313ea50d5ec31697bba1064',
    action: ['update', 'insert'],
    filter_condition: `stageVALCHANGES^EQ`,
    ...
    name: 'Request Update after Stage Change',
    order: 200,
    when: 'before',
    active: true,
    add_message: false,
    abort_action: false,
    description: "When stage changes, update the record's state and additional comments.",
})
