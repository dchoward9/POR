...
export default BusinessRule({
    $id: 'c7108f48937e6250d5ec31697bba103f',
    action: ['update'],
    filter_condition: `business_justificationVALCHANGES^ORdescription_of_servicesVALCHANGES^ORpartner_contact_informationVALCHANGES^ORsensitive_data_accessVALCHANGES^ORpartner_full_legal_nameVALCHANGES^EQ`,
