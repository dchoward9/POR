...
export default Acl({
    $id: '6f4b740793222e10d5ec31697bba108b',
    script: `// if (
...
//  var isDeptHead = deptHead == userID;
 ...
 if (isRequestedFor || isViewer) {
    ...
    decision_type: 'allow',
    description:
        "Allow-If ACL. Grants write access to a Request record for the Requester and Viewer personas. Access is granted if the current user is the 'Requested For' or has the 'viewer' role.",
