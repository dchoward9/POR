...
export default Acl({
    $id: '221625be9396e290d5ec31697bba10e1',
    script: `// if (
...
//  var isDeptHead = deptHead == userID;
 ...
 if (isRequestedFor || isViewer) {
    ...
    decision_type: 'deny',
    description:
        'Deny-Unless ACL. This rule acts as a gatekeeper, denying write access to all Request records by default. This prevents users with broad, inherited roles (like itil) from modifying records. Specific "Allow-If" rules are required to grant access.',
