...
export default Record({
    $id: '3a04c3e593dfe650d5ec31697bba10b3',
    ...
    data: {
        ...
        source_field: 'u_partner_contact_information',
	...
	return ""; // return the value to be put into the target field
        ...
        sys_name: 'u_partner_contact_information',
        target_field: 'partner_contact_information',
